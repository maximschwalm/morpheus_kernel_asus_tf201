...
FIXED_REG(4, en_vdd_bl,    en_vdd_bl,    NULL,                     0, 0, TEGRA_GPIO_PH3,  true, 1, 5000);
FIXED_REG(5, en_3v3_modem, en_3v3_modem, NULL,                     1, 0, TEGRA_GPIO_PD6,  true, 1, 3300);
FIXED_REG(6, en_vdd_pnl1,  en_vdd_pnl1,  FIXED_SUPPLY(en_3v3_sys), 0, 0, TEGRA_GPIO_PW1,  true, 1, 3300);
...
FIXED_REG(9, en_3v3_fuse,  en_3v3_fuse,  FIXED_SUPPLY(en_3v3_sys), 0, 0, TEGRA_GPIO_PC1,  true, 0, 3300);
...
/* Fixed regulator devices for Asus Transformers */
