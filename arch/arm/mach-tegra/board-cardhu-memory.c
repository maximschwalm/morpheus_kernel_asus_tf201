...
static const struct tegra_emc_table P1801_Hynix_1GB_800MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table P1801_Micron_1GB_800MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table P1801_Micron_2GB_800MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ME301T_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ME301T_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
			...
			0x00000008, /* MC_EMEM_ARB_TIMING_WAP2PRE */
			0x00000002, /* MC_EMEM_ARB_TIMING_R2R */
			0x00000004, /* MC_EMEM_ARB_TIMING_W2W */
			0x00000002, /* MC_EMEM_ARB_TIMING_R2W */
			0x00000006, /* MC_EMEM_ARB_TIMING_W2R */
			0x06020402, /* MC_EMEM_ARB_DA_TURNS */
			0x000a0502, /* MC_EMEM_ARB_DA_COVERS */
			0x74830303, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
	...
	},
	{
		...
		333500,     /* SDRAM frequency */
		{
			...
			0x00000003, /* MC_EMEM_ARB_TIMING_R2W */
			0x00000006, /* MC_EMEM_ARB_TIMING_W2R */
			0x06030402, /* MC_EMEM_ARB_DA_TURNS */
			0x000b0608, /* MC_EMEM_ARB_DA_COVERS */
			0x70850f09, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x00000004, /* MC_EMEM_ARB_TIMING_R2W */
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08040402, /* MC_EMEM_ARB_DA_TURNS */
			0x00130b10, /* MC_EMEM_ARB_DA_COVERS */
			0x70ea1f11, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
...
static const struct tegra_emc_table ME570_AP37_Elpida_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF502T_Elpida_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
	...
	},
	{
		...
		375000,     /* SDRAM frequency */
		{
			...
			0x00000006, /* MC_EMEM_ARB_TIMING_W2R */
			0x06030202, /* MC_EMEM_ARB_DA_TURNS */
			0x000c0609, /* MC_EMEM_ARB_DA_COVERS */
			0x7086110a, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
			0xff00ff89, /* EMC_CFG_RSV */
	...
	},
	{
		...
		750000,     /* SDRAM frequency */
		{
			...
			0x00000008, /* MC_EMEM_ARB_TIMING_W2R */
			0x08040202, /* MC_EMEM_ARB_DA_TURNS */
			0x00150c12, /* MC_EMEM_ARB_DA_COVERS */
			0x710c2213, /* MC_EMEM_ARB_MISC0 */
			0x001f0000, /* MC_EMEM_ARB_RING1_THROTTLE */
			0xe8000000, /* EMC_FBIO_SPARE */
			0xff00ff49, /* EMC_CFG_RSV */
...
static const struct tegra_emc_table TF502T_Hynix_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF502T_Micron_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF502TG_Elpida_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
...
static const struct tegra_emc_table TF502TG_Hynix_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF502TG_Micron_1GB_750MHZ[] = {
	{
		0x32,       /* Rev 3.2 */
		204000,     /* SDRAM frequency */
		{
...
static const struct tegra_emc_table ME570_T30SL_Elpida_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int cardhu_emc_init(void)
{
	...
	case BOARD_E1257:
		...
		else if(project_info == TEGRA3_PROJECT_TF502T)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF502T_Hynix_1GB_750MHZ\n");
				tegra_init_emc(TF502T_Hynix_1GB_750MHZ,
					ARRAY_SIZE(TF502T_Hynix_1GB_750MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF502T_Elpida_1GB_750MHZ\n");
				tegra_init_emc(TF502T_Elpida_1GB_750MHZ,
					ARRAY_SIZE(TF502T_Elpida_1GB_750MHZ));
			}
			else if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==1) )
			{
				printk("BOARD_PM269:TF502T_Micron_1GB_750MHZ\n");
				tegra_init_emc(TF502T_Micron_1GB_750MHZ,
					ARRAY_SIZE(TF502T_Micron_1GB_750MHZ));
			}
		}
		else if(project_info == TEGRA3_PROJECT_TF502TG)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF502TG_Hynix_1GB_750MHZ\n");
				tegra_init_emc(TF502TG_Hynix_1GB_750MHZ,
					ARRAY_SIZE(TF502TG_Hynix_1GB_750MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF502TG_Elpida_1GB_750MHZ\n");
				tegra_init_emc(TF502TG_Elpida_1GB_750MHZ,
					ARRAY_SIZE(TF502TG_Elpida_1GB_750MHZ));
			}
			else if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==1) )
			{
				printk("BOARD_PM269:TF502TG_Micron_1GB_750MHZ\n");
				tegra_init_emc(TF502TG_Micron_1GB_750MHZ,
					ARRAY_SIZE(TF502TG_Micron_1GB_750MHZ));
			}
		}
		...
		else if(project_info == TEGRA3_PROJECT_P1801)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:P1801_Hynix_1GB_800MHZ 09/07\n");
				tegra_init_emc(P1801_Hynix_1GB_800MHZ,
					ARRAY_SIZE(P1801_Hynix_1GB_800MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:P1801_Micron_1GB_800MHZ 09/11\n");
				tegra_init_emc(P1801_Micron_1GB_800MHZ,
					ARRAY_SIZE(P1801_Micron_1GB_800MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==1) )
			{
				printk("BOARD_PM269:P1801_Micron_2GB_800MHZ 10/03\n");
				tegra_init_emc(P1801_Micron_2GB_800MHZ,
                                        ARRAY_SIZE(P1801_Micron_2GB_800MHZ));

			}	
		}
		else if(project_info == TEGRA3_PROJECT_ME301T)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:ME301T_Elpida_1GB_667MHZ 10/02\n");
				tegra_init_emc(ME301T_Elpida_1GB_667MHZ, ARRAY_SIZE(ME301T_Elpida_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:ME301T_Hynix_1GB_667MHZ\n");
				tegra_init_emc(ME301T_Hynix_1GB_667MHZ, ARRAY_SIZE(ME301T_Hynix_1GB_667MHZ));
			}
		}
		else if(project_info == TEGRA3_PROJECT_ME570T)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:ME570_T30SL_Elpida_667MHZ\n");
				tegra_init_emc(ME570_T30SL_Elpida_667MHZ, ARRAY_SIZE(ME570_T30SL_Elpida_667MHZ));
			}
			else if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==1) )
			{
				printk("BOARD_PM269:ME570_AP37_Elpida_667MHZ\n");
				tegra_init_emc(ME570_AP37_Elpida_667MHZ, ARRAY_SIZE(ME570_AP37_Elpida_667MHZ));
			}
		}
